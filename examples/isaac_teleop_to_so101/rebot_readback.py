...
from .common import ROBOT_PROFILES

PROFILE_KEY = "rebot_b601_rs_follower"
...
def main() -> None:
    ...
    robot = RebotB601RSFollower(
        RebotB601RSFollowerRobotConfig(port=args.port, can_adapter=args.can_adapter, id=args.id)
    )
